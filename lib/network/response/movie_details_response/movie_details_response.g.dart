...
class MovieDetailsResponseAdapter extends TypeAdapter<MovieDetailsResponse> {
  ...
  MovieDetailsResponse read(BinaryReader reader) {
    ...
    return MovieDetailsResponse(
      ...
      belongsToCollection: fields[2] as BelongsToCollectionVO?,
      budget: fields[3] as int?,
      genres: (fields[4] as List?)?.cast<GenresVO>(),
      ...
      productionCompanies: (fields[13] as List?)?.cast<ProductionCompaniesVO>(),
      productionCountries: (fields[14] as List?)?.cast<ProductionCountriesVO>(),
      releaseDate: fields[15] as String?,
      revenue: fields[16] as int?,
      runtime: fields[17] as int?,
      spokenLanguages: (fields[18] as List?)?.cast<SpokenLanguagesVO>(),
